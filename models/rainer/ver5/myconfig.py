...
#ROI_CROP_BOTTOM = 17 #ab 103 = 120-103=17                #the number of rows of pixels to ignore on the bottom of the image
# 
...
JOYSTICK_MAX_THROTTLE = 0.85 ####FAST### 0.7 #0.5         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
#JOYSTICK_MAX_THROTTLE = 0.30 ####SLOW### 0.7 #0.5         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "/home/rainer/dev/37-donkey3/DonkeySimLinux/donkey_sim.x86_64" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64"
DONKEY_GYM_ENV_NAME = "donkey-generated-track-v0" # ("donkey-generated-track-v0"|"donkey-generated-roads-v0"|"donkey-warehouse-v0"|"donkey-avc-sparkfun-v0")
#DONKEY_SIM_PATH = "remote"
#SIM_HOST = "trainmydonkey.com"
#SIM_HOST = "donkeysim.paje.ca"
SIM_ARTIFICIAL_LATENCY = 220
#GYM_CONF = { "body_style" : "car01", "body_rgb" : (256, 256, 20), "car_name" : "rainer", "font_size" : 100} 
#GYM_CONF = { "body_style" : "car01", "body_rgb" : (256, 256, 20), "car_name" : "ValleyCrawler", "font_size" : 50} 
GYM_CONF = { "body_style" : "car01", "body_rgb" : (256, 256, 20), "car_name" : "Parking Lot Nerds", "font_size" : 50} 
...
AI_LAUNCH_DURATION = 6.0            # the ai will output throttle for this many seconds
AI_LAUNCH_THROTTLE = 1.8            # the ai will output this throttle value
# AI_LAUNCH_ENABLE_BUTTON = 'R2'      # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
# AI_LAUNCH_KEEP_ENABLED = False      # when False ( default) you will need to hit the AI_LAUNCH_ENABLE_BUTTON for each use. This is safest. When this True, is active on each trip into "local" ai mode.
# 
# #Scale the output of the throttle of the ai pilot for all model types.
AI_THROTTLE_MULT = 10.0              # this multiplier will scale every throttle value for all output from NN models
# 
# #Path following
