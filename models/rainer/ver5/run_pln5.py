...
def test_clients():
    ...
    # Car config
    msg = '{ "msg_type" : "car_config", "body_style" : "car01", "body_r" : "255", "body_g" : "0", "body_b" : "255", "car_name" : "Parking Lot Nerds", "font_size" : "50" }'
    clients[0].send(msg)
    time.sleep(1)
